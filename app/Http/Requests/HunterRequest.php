...
class HunterRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch($this->method())
        {
            ...
            default:
                return [
                    'method' => 'O método HTTP :method não é suportado para definir as regras de validação, apenas é permitido POST e PATCH.',
                ];
        }
    }
    ...
    public function messages()
    {
        switch($this->method())
        {
            ...
            default:
                return [
                    'method' => 'O método HTTP :method não é suportado para definir as mensagens de validação, apenas é permitido POST e PATCH.',
                ];
        }
    }
}
